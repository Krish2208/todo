import { CheckBox, Delete, Done } from '@mui/icons-material';
    ...
    return <div>
        <Tooltip arrow title={props.todo.description} TransitionComponent={Zoom}>
            <Card sx={{ marginY: '5px', marginX: `${props.margin}` }}>
                <CardHeader avatar={<Avatar sx={{ bgcolor: completed ? '#EDF7ED' : '#FFF4E5' }}><CheckBox sx={{color: completed ? '#5CB660' : '#FFA117'  }}/></Avatar>} action={<span>
